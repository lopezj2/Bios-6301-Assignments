...
In the football problem you've added a requisite that there is at least 1 player in each position via the following code:   x2[qb.ix, 'marg'] <- x2[qb.ix,'points'] - x2[qb.ix[max(1,posReq['qb'])*nTeams],'points']
...
**JC Grading -3**
Check the newton rhapson function.  It converges to 10.99471 rathern than 0.7390851.
